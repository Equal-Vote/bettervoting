...
// No asm group. Everything we send is transactional (ballot invites and
// receipts), and tagging a message with an unsubscribe group makes SendGrid
// add List-Unsubscribe headers plus an unsubscribe footer to the html and
// plain text parts.
...
function emailTemplate(content: string) {
  ...
  // 4. delete the UNSUBSCRIBE_LINK block, see the note on emailSettings above
